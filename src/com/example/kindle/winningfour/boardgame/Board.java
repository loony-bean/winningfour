...
public class Board implements IBoard2D
{
	...
	public static void initHash()
	{
		...
		for (int p = 0; p < ClassicRules.PLAYERS_MAX; p++)
		{
			for (int x = 0; x < ClassicRules.WIDTH_MAX; x++)
			{
				for (int y = 0; y < ClassicRules.HEIGHT_MAX; y++)
				{
	...
	static private int zobrist[][][] = new int[ClassicRules.PLAYERS_MAX][ClassicRules.WIDTH_MAX][ClassicRules.HEIGHT_MAX];
